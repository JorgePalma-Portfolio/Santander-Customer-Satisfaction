...
data_0 <- data.frame(pc01=pcomp$scores[,1], pc02=pcomp$scores[,2])
...
#data_1$custom7 <- 1/(1+exp(-all_data$saldo_medio_var5_hace3))
#data_1$custom8 <- 1/(1+exp(-all_data$num_var4))

#data_1$custom9  <- (10^all_data$ind_var5_0) + all_data$ind_var5
